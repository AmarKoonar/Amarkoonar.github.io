...
export default function Footer() {
  ...
  return (
    <div className="w-full bg-black transition duration-300 z-50">
            ...
            <nav className=" p-3 text-white flex flex-col items-center justify-center duration-500 group-hover:shadow-[#00FFDE] border-0 hover:border-[#00FFDE] border-t-[#00CAFF] lg:border-t-2 border-t-1 glass-effect">
